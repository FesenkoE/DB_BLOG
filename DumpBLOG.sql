...
CREATE TABLE `comments` (
  ...
  CONSTRAINT `posts_id` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `level_id` FOREIGN KEY (`level_id`) REFERENCES `levels` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2019-02-23 22:51:34
